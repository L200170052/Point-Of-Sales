...
<div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
            <form action="<?php echo base_url().'kasir/data_retur/simpan_retur'?>" method="post">
            <table>
                <tr>
                    <th>Kode Barang</th>
                </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;"><?php echo $items['retur_keterangan'];?></td>
                         <td style="text-align:center;"><a href="<?php echo base_url().'kasir/data_retur/hapus_retur/'.$items['retur_id'];?>" class="btn btn-warning btn-xs"><span class="fas fa-close"></span> Batal</a></td>
                    </tr>
        ...
        $(document).ready(function(){
            ...
            $("#kode_brg").on("input",function(){
                var kobar = {kode_brg:$(this).val()};
                   $.ajax({
               type: "POST",
               url : "<?php echo base_url().'kasir/data_retur/get_barang';?>",
               data: kobar,
