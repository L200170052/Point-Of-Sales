<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="<?php echo base_url() . 'admin/data_penjualang/add_to_cart' ?>" method="post">
                    <table>
                        <tr>
                            <th>Kode Barang</th>
                        </tr>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($this->cart->contents() as $items) : ?>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;"><a href="<?php echo base_url() . 'admin/data_penjualang/remove/' . $items['rowid']; ?>" class="btn btn-warning btn-xs"><span class="fas fa-close"></span> Batal</a></td>
                            </tr>
                ...
                <form action="<?php echo base_url() . 'admin/data_penjualang/simpan_penjualan_grosir' ?>" method="post">
                    <table>
                        <tr>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $("#kode_brg").on("input", function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url() . 'admin/data_penjualang/get_barang'; ?>",
                        data: kobar,
