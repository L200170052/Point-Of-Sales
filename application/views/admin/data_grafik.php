                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <a class="btn btn-sm btn-default" href="<?php echo base_url() . 'admin/data_grafik/graf_stok_barang' ?>" target="_blank"><span class="fas fa-eye"></span> Lihat</a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <a class="btn btn-sm btn-default" href="#lap_jual_perbulan" data-toggle="modal"><span class="fas fa-eye"></span> Lihat</a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <a class="btn btn-sm btn-default" href="#lap_jual_pertahun" data-toggle="modal"><span class="fas fa-eye"></span> Lihat</a>
                            </td>
                        </tr>
        ...
        <div class="modal fade" id="lap_jual_perbulan" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/data_grafik/graf_penjualan_perbulan' ?>" target="_blank">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-info"><span class="fas fa-eye"></span> Lihat</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal fade" id="lap_jual_pertahun" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/data_grafik/graf_penjualan_pertahun' ?>" target="_blank">
                        <div class="modal-body">
