...
<div class="row">
    <div class="col-lg-12">
    <form action="<?php echo base_url().'admin/data_pembelian/add_to_cart'?>" method="post">
    <table>
        <tr>
    ...
    <table class="table table-bordered table-condensed" style="font-size:11px;margin-top:10px;">
        ...
        <tbody>
            ...
            <tr>
                 ...
                 <td style="text-align:center;"><a href="<?php echo base_url().'admin/data_pembelian/remove/'.$items['rowid'];?>" class="btn btn-warning btn-xs"><span class="fas fa-close"></span> Batal</a></td>
            </tr>
            <?php $i++; ?>
            <?php endforeach; ?>
        </tbody>
    ...
    <a href="<?php echo base_url().'admin/data_pembelian/simpan_pembelian'?>" class="btn btn-info btn-lg"><span class="fas fa-save"></span> Simpan</a>
    </div>
</div>
<!-- /.row -->
...
$(document).ready(function(){
    ...
    $("#kode_brg").keyup(function(){
        var kobar = {kode_brg:$(this).val()};
           $.ajax({
       type: "POST",
       url : "<?php echo base_url().'admin/data_pembelian/get_barang';?>",
       data: kobar,
