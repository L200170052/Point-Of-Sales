<?php
class Data_penjualang extends CI_Controller
{
    ...
    function index()
    {
        ...
        $this->load->view('admin/penjualangrosir', $data);
    ...
    function get_barang()
    {
        ...
        $this->load->view('admin/detail_barang_jual_grosir', $x);
        } else {
             echo "Halaman tidak ditemukan";
         }
    }
    function add_to_cart()
    {
        ...
        redirect('admin/data_penjualang');
