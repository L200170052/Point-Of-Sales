<?php
class Data_transaksie extends CI_Controller
{
    ...
    function index()
    {
        ...
        $this->load->view('kasir/transaksieceran', $data);
    ...
    function get_barang()
    {
        ...
        $this->load->view('kasir/detail_barang_jual', $x);
        } else {
             echo "Halaman tidak ditemukan";
         }
    }
    function add_to_cart()
    {
        ...
        redirect('kasir/data_transaksie');
