...
class M_laporan extends CI_Model
{
    ...
    {
    $sql = "SELECT sum(d_jual_total) as d_jual_total FROM tbl_detail_jual";
    $result = $this->db->query($sql);
    return $result->row()->d_jual_total;
    }

    public function get_summ()
    {
    $sql = "SELECT sum(barang_stok) as barang_stok FROM tbl_barang";
    $result = $this->db->query($sql);
    return $result->row()->barang_stok;
    }
}
